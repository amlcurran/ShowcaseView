...
public class ShowcaseView extends RelativeLayout
	...
	private int boxXPosShift;
	private int boxYPosShift;
	
	//Width of text elements of showcase
    ...
    public static class Builder {
		...
		public Builder boxPostionShift(int boxXPosShift, int boxYPosShift) {
			showcaseView.boxXPosShift = boxXPosShift;
			showcaseView.boxYPosShift = boxYPosShift;
			showcaseView.hasManualBoxPosShift = true;
		    return this;
		}
